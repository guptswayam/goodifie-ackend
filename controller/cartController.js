...
exports.getItemsByUser= (req, res, next)=>{
    const Q= "select cart.id as id, product_id, user_id, cover_image, category, price, discount, name from cart join products on cart.product_id=products.id where cart.user_id=? order by price desc";
